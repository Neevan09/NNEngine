...
public:
	...
	void OnMouseUp();
	void CreateObject(float x, float y, float width, float height, XMFLOAT4 color);
	void CreateObject(float x, float y, float width, float height, Material *material, XMFLOAT4 color);
	...
	UIRadioButton * CreateRadioButton(float x, float y, float width, float height, XMFLOAT4 color, UIRadioGroup *radioGroup);
